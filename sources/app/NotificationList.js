...
*/
window.sportsnewsfeedapp.app.NotificationList = function () {
    /**
...
*/
window.sportsnewsfeedapp.app.NotificationList.prototype.registerListener = function(listener) {
    var id = null;
    if (listener) {
        this.idCounter += 1;
...
*/
window.sportsnewsfeedapp.app.NotificationList.prototype.unregisterListener = function(id) {
    if (id) {
...
*/
window.sportsnewsfeedapp.app.NotificationList.prototype.notifyAll = function(notificationType, args) {
    if (notificationType) {
