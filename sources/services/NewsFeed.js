...
* @file NewsFeed.js
* @fileOverview 
* File containing the declaration of the NewsFeed class.
...
/**
* Declares a NewsFeed.
* @class Object Class that is used by the Models and Services. Represents a single sport news feed.
* @exports ns_services as window.sportsnewsfeedapp.services
*/
ns_services.NewsFeed = function () {

	//private properties
    /**
     * An example from ESPN:
     * 		A "country": "Canada",
     *				"price": "3.65",
